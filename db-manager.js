    ...
    initializeDatabase() {
        ...
        return {
            ...
            products: [
                {
                    id: 1,
                    name: 'SolarDry Compact – Small Farm Unit',
                    modelId: 'SD-100',
                    price: 25000,
                    description: 'Ideal for individual farmers drying up to 10 kg per batch. Compact, portable, and perfect for fruits, vegetables, and herbs.',
                    image: 'https://placehold.co/400x250/2a9d8f/ffffff?text=Small+Farm+Dryer',
                    status: 'active',
                    createdDate: '2025-01-01'
                },
                {
                    id: 2,
                    name: 'SolarDry Plus – Medium Community Dryer',
                    modelId: 'SD-300',
                    price: 75000,
                    description: 'Designed for farmer groups and co-operatives. Handles 25–50 kg per batch with enhanced airflow and dual-tray system.',
                    image: 'https://placehold.co/400x250/e9c46a/264653?text=Medium+Community+Dryer',
                    status: 'active',
                    createdDate: '2025-01-02'
                },
                {
                    id: 3,
                    name: 'SolarDry Pro – Large Commercial Dryer',
                    modelId: 'SD-750',
                    price: 200000,
                    description: 'Built for agri-businesses and food processors. Capacity of 100–200 kg per batch with fan-assisted convection and temperature control.',
                    image: 'https://placehold.co/400x250/f4a261/ffffff?text=Large+Commercial+Dryer',
                    status: 'active',
                    createdDate: '2025-01-03'
                },
                {
                    id: 4,
                    name: 'SolarDry Max – Industrial High-Flow System',
                    modelId: 'SD-2000',
                    price: 500000,
                    description: 'Top-tier industrial system for large-volume processing units. Handles 500+ kg per batch with automated controls and multi-zone drying.',
                    image: 'https://placehold.co/400x250/264653/e9c46a?text=Industrial+System',
                    status: 'active',
